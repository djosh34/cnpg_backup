...
- Concurrent retention and backup; interrupted deletion; retained old full supporting a recent differential; last usable full retained after prolonged failure; external/read-only restore with the approved acknowledged retention-pause protocol.
