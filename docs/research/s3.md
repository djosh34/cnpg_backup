...
These notes explain the storage assumptions behind the [repository protocol](../repository.md). SDK references use minio-go v7.3.0 at `ce0e323c55c64964e6ad820ef0c6f5b286446aae`. MinIO references use `RELEASE.2025-09-07T16-13-09Z` at `07c3a429bfed433e49018cb0f78a52145d4bedeb`.
