...
REGISTRY = (
    ...
    {'id': 'retention-runtime', 'method': 'case_retention_runtime', 'group': 'differential', 'fixtures': ['source', 'differential'], 'requires': [], 'seconds': 1200, 'max_targets': 2, 'requirement': 'design §4/6; PR I actual bounded expiration, old full/D parent closure, remote SQL recovery and nonexpiring cross-cluster replay/crash protection'},
    ...
    {'id': 'operational-rotation-resources', 'method': 'case_operational_rotation_resources', 'group': 'operations', 'fixtures': ['source', 'differential', 'ops-rotation'], 'requires': [], 'seconds': 1800, 'max_targets': 1, 'requirement': 'PR J: actual bounded Go RSS/native cgroup/workspace, WAL during sustained large transfer, valid credential/private-root overlap and SQL recovery'},
    {'id': 'operational-update-fixtures', 'method': 'case_operational_update_fixtures', 'group': 'operations', 'fixtures': ['source', 'differential', 'ops-upgrade'], 'requires': [], 'seconds': 1800, 'max_targets': 1, 'requirement': 'PR J: distinct-image rolling plugin update, retained initial v1 full/differential/WAL bytes with hashes/provenance and fresh target SQL; first-release predecessor N/A'},
...
BRANCHES = {
    'retention-runtime': ('expiration-window', 'protected-replay', 'crashed-guard'),
